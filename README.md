...
- **Yelp Fake Review Detection-** Fine-tuned BERT and RoBERTa, implemented gradient boosting and deep neural networks (LSTM, CNN) for detection of fake reviews, achieving 0.88 AUCROC; identified and analyzed features that led to flagging. (DSF)
